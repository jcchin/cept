...
class HeatSink(Component):
    def __init__(self):
        ...
        self.add_param('InvPwr', 300.0, desc='total power through the inverter', units='W')
        self.add_param('Inv_eff', 0.0, desc='inverter efficiency')
        self.add_param('T_air', 47., desc='Cooling Air Temp', units='degC')
        self.add_param('T_max', 100., desc='Maximum Electronics Temp', units='degC')
        self.add_param('sink_w', .15, desc='Heat Sink Base Width', units='m')
        self.add_param('sink_l', .02, desc='Heat Sink Base Length', units='m')
        self.add_param('sink_h', .002, desc='Heat Sink Base Height', units='m')
        self.add_param('avail_h', 0.04, desc='maximum available height for heat sink', units='m')
        ...
        self.add_param('cfm', 0.0015, desc='flow rate in cubic feet per minute', units='m**3/s')
    ...
    def solve_nonlinear(self, p, u, r):
        ...
        V = u['V_in']  = p['cfm']/(p['sink_w']*H-(H*u['n_fins']*u['fin_w']))
        print('V',V)
