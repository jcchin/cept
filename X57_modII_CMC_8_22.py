...
#1 = CMC_Temp_Ad  # adiabatic cmc temperature (for high power transient studies)
#2 = Inlet_Temp      # nacelle inlet air temperature
...
def dxdt(temp, t):
    ...
    return [dT_CMC, dT_CMC_Ad, dT_Inlet, dT_Motor_Ex]

#Integrate
Temp_states = integrate.odeint(dxdt, [T_init,T_init,T_init,T_init], times, hmax=1.)
...
ax1.plot(times, Temp_states[:,0], 'r-', label='CMC sink Temp')
